      ...
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="space-y-6 text-center md:text-left">
          <h1 className="text-5xl md:text-5xl font-bold">
            <span className="text-primary">Keila Tabagan</span>
          </h1>
          ...
          <div className="flex justify-center md:justify-start">
            <a
              href="/resume.pdf"
              download
              className="inline-block px-6 py-3 rounded-lg bg-primary text-primary-foreground hover:bg-red-800 hover:opacity-90 transition"
            >
              Download Resume
            </a>
          </div>
